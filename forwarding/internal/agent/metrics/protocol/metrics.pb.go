...
type InitRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Metrics       *Metrics               `protobuf:"bytes,1,opt,name=metrics,proto3" json:"metrics,omitempty"` // Metrics
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
var file_metrics_proto_depIdxs = []int32{
	...
	6,  // 8: proto.InitRequest.metrics:type_name -> proto.Metrics
	14, // 9: proto.RegionPairAssessment.ip_pairs:type_name -> proto.IPPairAssessment
	6,  // 10: proto.SyncRequest.metrics:type_name -> proto.Metrics
