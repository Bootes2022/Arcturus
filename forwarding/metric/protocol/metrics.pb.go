...
type InitRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Metrics       *Metrics               `protobuf:"bytes,1,opt,name=metric,proto3" json:"metric,omitempty"` // Metrics
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
var file_metrics_proto_depIdxs = []int32{
	...
	6,  // 8: proto.InitRequest.metric:type_name -> proto.Metrics
	14, // 9: proto.RegionPairAssessment.ip_pairs:type_name -> proto.IPPairAssessment
	6,  // 10: proto.SyncRequest.metric:type_name -> proto.Metrics
